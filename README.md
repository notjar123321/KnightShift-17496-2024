...
## Welcome to KnightShift 17496!
This GitHub repository contains the source code that is used to our Android app to control our FTC robot.  To use this, download/clone the entire project to your local computer.
